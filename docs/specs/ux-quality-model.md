...
- Testing with users:
  ...
  - 1. The user receives AI assistance.
  - 1. The user solves further tasks (measurement of correct answers).
  - 1. Caluclate the diffrence in test score before and after the usage of ESBot
